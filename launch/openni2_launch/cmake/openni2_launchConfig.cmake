...
if("FALSE" STREQUAL "TRUE")
  set(openni2_launch_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-openni2-launch-0.4.2)
  set(openni2_launch_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-openni2-launch-0.4.2/obj-x86_64-linux-gnu/devel)
  ...
  set(openni2_launch_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Isaac I. Y. Saito <isaac.saito@plusonerobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Isaac I. Y. Saito <isaac.saito@plusonerobotics.com>' to fix it.")
    endif()
